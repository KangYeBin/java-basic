...
//		System.out.println("정적 변수 c1.b = " + c1.b);
//		System.out.println("정적 변수 c2.b = " + c2.b);
		System.out.println("정적 변수 c3.b = " + Count.b);
		System.out.println("정적 변수 c1.b = " + Count.b);
		System.out.println("정적 변수 c2.b = " + Count.b);

		/*
			- static이 붙은 데이터는 그 static 데이터가 선언된 클래스의 이름으로 바로 참조 가능
			- 일반 멤버 변수(필드)와 혼동할 가능성이 있기 때문에 주소값으로 접근하지 않는다
		*/
